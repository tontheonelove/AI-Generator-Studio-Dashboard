...
import { ToolsControls } from '@/components/studio/tools-controls';
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-6 lg:flex-row">
        <div className="w-full rounded-2xl border border-slate-200 bg-white/80 p-6 shadow-xl backdrop-blur-xl dark:border-slate-800 dark:bg-slate-900/40 lg:w-1/3">
          <h2 className="mb-4 flex items-center gap-2 text-lg font-semibold">
            <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-amber-500 to-yellow-500 text-white shadow-lg">
              🛠️
            </span>
            <span className="gradient-text-premium">Tools</span>
          </h2>
          <ToolsControls onLoading={setLoading} onResult={setResult} />
        </div>
